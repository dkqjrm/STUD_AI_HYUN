...
if __name__ == "__main__":
    ...
    logger = TensorBoardLogger(save_dir="./Studs", name="lr{}_batch{}_ac{}_epoch{}_pat{}_red{}".format(args["learning_rate"], args["batch_size"], args["accumulate"], args['epoch'], args['patience'], args['reduction']))
    ...
    checkpoint = ModelCheckpoint(dirpath="./output",
                                 filename="{epoch}_{val_epoch_f1:.2f}_" + "lr{}_batch{}_red{}".format(args["learning_rate"], args["batch_size"], args["reduction"]),
