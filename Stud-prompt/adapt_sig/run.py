...
if __name__ == "__main__":
    ...
    logger = TensorBoardLogger(save_dir="./Studs", name="lr{}_batch{}_ac{}_epoch{}_pat{}_red{}_pre{}".format(args["learning_rate"], args["batch_size"], args["accumulate"], args["epoch"], args["patience"], args['reduction'], args['pre_seq_len']))
